    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFieldsAndScroll(async (err, values) => {
            if (!err) {
                ...
                const { la, lo } = this.state.location;
                console.log(la, lo);
                if (la && lo) {
                    // Todo call API
                } else {
        ...
        return (
            <Form {...formItemLayout} onSubmit={this.handleSubmit} style={{ minWidth: '500px' }}>
                ...
                <Form.Item label="Chiều cao">
                    {getFieldDecorator('height', _fieldDecorator.height)(
                        <Input
                ...
                <Form.Item label="Địa chỉ">
                    <Button type='primary' onClick={this.handleGetLocation}>Lấy địa chỉ</Button>
                </Form.Item>
                ...
                <Form.Item>
                    <Row>
                        <Col >
                            <Button type="primary" htmlType="submit" style={{ width: '100%' }} loading={this.state.signUpLoading}>
                                Đăng ký
                            </Button>
